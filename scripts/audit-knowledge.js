...
const LINE_ANNOUNCEMENT_REPLY_CASES = [
  ["2026/5/19 週二晚上李齊泰醫師有看診嗎？請依 LINE VOOM 公告回答。", ["5/19", "李齊泰醫師", "停診一次", "匿名篩檢"]],
  {
    question: "我看到 5/19 晚上李齊泰醫師停診，那天如果只是要做匿名篩檢或打疫苗，還能去嗎？請簡短回答。",
    expectedTerms: ["過去 LINE VOOM 公告", "5/19", "李齊泰醫師", "停診一次", "當時公告寫", "匿名篩檢", "疫苗接種服務照常", "今天/最新安排", "電話確認"],
    forbiddenTerms: ["100%匿名篩檢", "服務照常營業", "官方 LINE", "線上掛號"]
  },
  {
...
const BASIC_INFO_REPLY_CASES = [
  ...
  { question: "開車去附近可以停哪裡？", expectedTerms: ["特約停車", "停車折抵", "櫃台確認", "台灣聯通停車場", "聯邦佳佳大樓停車場"], forbiddenTerms: ["沒有明確確認特約停車", "不能當作一定有停車折抵"] },
  {
    question: "我開車去方便嗎？附近有特約停車或停車場嗎？不要貼連結，講重點。",
    expectedTerms: ["特約停車", "停車折抵", "櫃台確認", "台灣聯通停車場－將捷二場", "聯邦佳佳大樓停車場"],
    forbiddenTerms: ["附近的附近停車場", "沒有明確確認特約停車", "不能當作一定有停車折抵", "https://"]
  },
