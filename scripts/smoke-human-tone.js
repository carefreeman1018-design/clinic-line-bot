...
const cases = [
  ...
  {
    name: "doctor review flow keeps vaccine suitability boundary before waiting reply",
    reply: await buildDoctorReviewTestReply("我想今天直接打九價 HPV 疫苗，月經晚了幾天不確定有沒有懷孕，以前打疫苗也過敏起疹子。可以直接打嗎？費用多少？我先傳訊息問就好。"),
    expected: ["HPV", "九價", "是否適合施打不能只靠訊息判斷", "是否懷孕", "過敏史", "今天能不能直接打", "轉請醫師或診所人員確認", "確認後會再回覆你"],
    forbidden: ["可以直接打", "今天可以直接打", "費用是", "價格是", "元", "只要等", "等醫師回覆再說", "官網介紹：", "https://", "lin.ee"]
  },
  {
    name: "doctor review flow keeps genital ulcer medication boundary before waiting reply",
    reply: await buildDoctorReviewTestReply("我陰莖上這兩天冒出一排小水泡，今天破皮潰瘍又刺痛，朋友說可能皰疹或梅毒，叫我自己先擦藥膏或吃剩下的抗生素。我可以先這樣處理，等醫師回覆再說嗎？"),
    expected: ["陰莖水泡", "破皮潰瘍", "刺痛", "只靠文字不能診斷或開藥", "不建議自己先擦藥膏", "吃剩下的抗生素", "轉請醫師或診所人員確認", "確認後會再回覆你"],
  ...
  },
  {
    ...
    reply: await buildTestReply("我做完男性結紮第 2 天，陰囊越來越腫，瘀青範圍變大，傷口還有一點滲血，現在很痛又有點發燒。可以冰敷吃止痛藥等明天嗎？還是要現在回診或急診？我有點緊張，先跟我說下一步。"),
    expected: ["結紮後第 2 天", "陰囊越來越腫", "瘀青變大", "傷口滲血", "很痛", "發燒", "光靠訊息無法判斷嚴重度", "術後血腫", "感染", "持續出血", "不建議", "冰敷", "止痛藥", "等到明天", "02-2511-9488", "急診", "立即就醫"],
  ...
  },
  {
    ...
    reply: await buildTestReply("我爸 70 歲有糖尿病，今天陰囊和會陰部突然紅腫很痛，有一塊皮膚變黑，還發燒、整個人有點昏沉。這可以等明天門診嗎？你們今天能不能直接處理？我有點緊張，先跟我說下一步。"),
    expected: ["70 歲", "糖尿病", "陰囊", "會陰", "皮膚變黑", "發燒", "昏沉", "佛尼爾氏壞疽", "快速惡化感染", "光靠訊息無法診斷", "不建議等明天門診", "敗血症", "急診", "立即就醫", "廣效抗生素", "緊急清創", "02-2511-9488"],
    forbidden: ["官網介紹：", "https://", "lin.ee", "16 歲", "睪丸扭轉", "黃金六小時", "可以等明天", "先預約門診"]
  },
  {
    name: "fournier warning does not invent age or diabetes",
    reply: await buildTestReply("我陰囊跟會陰這兩天腫起來很痛，皮膚有點變黑，今天還發燒。這可以明天再去掛號嗎？還是先去急診？"),
    expected: ["陰囊", "會陰", "皮膚變黑", "發燒", "佛尼爾氏壞疽", "快速惡化感染", "光靠訊息無法診斷", "不建議等明天門診", "敗血症", "急診", "立即就醫", "廣效抗生素", "緊急清創", "02-2511-9488"],
  ...
  },
  {
    ...
    reply: await buildTestReply("我兒子 16 歲，剛剛運動後突然左邊睪丸痛到走不了，陰囊也有點腫，沒有明顯外傷。可以先吃止痛藥觀察到明天嗎？你們今天能不能直接檢查或處理？我有點緊張，先跟我說下一步。"),
    expected: ["16 歲", "突然單側睪丸痛", "陰囊腫", "睪丸扭轉", "急性陰囊", "光靠訊息無法診斷", "不建議", "止痛藥", "拖到隔天", "缺血風險", "黃金六小時", "急診", "立即就醫", "醫師評估", "02-2511-9488"],
    forbidden: ["官網介紹：", "https://", "lin.ee", "可以先吃止痛藥", "觀察到明天", "先預約門診", "不用急診"]
  },
  {
    name: "adult sudden testicular pain preserves stated age",
    reply: await buildTestReply("我 28 歲，今天下午突然左邊睪丸很痛，走路會痛，陰囊有點腫。可以先吃止痛藥睡一晚明天再看嗎？"),
    expected: ["28 歲", "突然單側睪丸痛", "陰囊腫", "走路受影響", "睪丸扭轉", "急性陰囊", "光靠訊息無法診斷", "不建議", "止痛藥", "拖到隔天", "缺血風險", "急診", "立即就醫", "02-2511-9488"],
  ...
  },
  {
    ...
    reply: await buildTestReply("我昨晚吃了朋友給的威而鋼，現在已經勃起快 5 個小時還退不下來，陰莖很痛。我可以先冰敷或睡一覺等它退嗎？你們今天能不能直接幫我處理？我有點緊張，先跟我說下一步。"),
    expected: ["勃起快 5 小時", "退不下來", "陰莖疼痛", "持續勃起", "缺血風險", "光靠訊息無法診斷", "不建議只冰敷", "睡覺", "等待自行消退", "立即就醫", "急診", "醫師評估", "02-2511-9488"],
    forbidden: ["官網介紹：", "https://", "lin.ee", "先預約泌尿科門診", "可以先冰敷", "等它退", "不用急診", "低能量震波"]
  },
  {
    name: "penile fracture warning beats sexual function route",
    reply: await buildTestReply("剛剛做愛時陰莖突然啪一聲，馬上軟掉，現在腫起來又瘀青很痛。我可以先冰敷等明天再看嗎？"),
    expected: ["陰莖突然啪一聲", "馬上軟掉", "腫脹", "瘀青", "明顯疼痛", "陰莖折斷", "白膜破裂", "急症", "光靠訊息無法診斷", "不建議只冰敷", "等到明天", "急診", "立即就醫", "02-2511-9488"],
  ...
  },
  {
    ...
    reply: await buildTestReply("我昨晚性行為後包皮翻下來卡在龜頭後面，現在龜頭腫紫、很痛，尿也有點尿不出來。我可以自己硬推回去或等明天再掛號嗎？你們今天能不能直接處理？我有點緊張，先跟我說下一步。"),
    expected: ["包皮卡在龜頭", "龜頭腫紫", "很痛", "尿不太出來", "嵌頓性包莖", "光靠訊息無法診斷", "不建議自己硬推", "不建議等到明天", "立即就醫", "急診", "醫師評估", "02-2511-9488"],
  ...
  },
  {
    ...
    reply: await buildTestReply("我現在左腰痛到冒冷汗，尿有點紅，還有發燒，怕是輸尿管結石。可以先吃止痛藥等明天嗎？你們今天能不能直接幫我體外震波或鈥雷射碎石？費用多少？我有點緊張，先跟我說下一步。"),
    expected: ["尿色發紅", "腰痛", "側腹痛", "發燒", "腎臟", "輸尿管", "感染", "結石合併感染", "光靠訊息無法判斷", "急診", "立即就醫", "不建議", "止痛藥", "撐到明天", "體外震波", "鈥雷射碎石", "費用", "02-2511-9488"],
  ...
  },
  {
    ...
    expected: ["輸尿管鏡", "碎石後", "血尿", "腰痛", "排尿明顯變少", "不能只靠訊息判斷", "尿液滯留", "輸尿管阻塞", "術後併發症", "不建議", "喝很多水", "等到明天", "02-2511-9488", "急診", "立即就醫"],
  ...
  },
  {
    ...
    expected: ["攝護腺肥大", "水蒸氣消融", "綠光雷射", "Urolift", "醫師", "攝護腺大小", "症狀", "身體狀況", "不能直接線上判斷", "不能先保證", "保留射精", "不用插尿管", "02-2511-9488"],
  ...
  },
  {
    ...
    expected: ["幾乎尿不出來", "下腹脹痛", "冒冷汗", "急性尿液滯留", "泌尿道阻塞", "光靠訊息無法診斷", "不建議撐到明天", "導尿", "急診", "立即就醫"],
  ...
  },
  {
    ...
    reply: answerPepVisitScheduleFollowUp(
      ...
      [
        ...
        { role: "assistant", content: "40 小時仍在 72 小時內，PEP 需要由醫師評估，不能直接線上開藥。" }
      ]
    ),
  ...
  },
  {
    ...
    reply: answerPepVisitScheduleFollowUp(
      ...
      [
        ...
        { role: "assistant", content: "18 小時仍在 72 小時內，PEP 需要由醫師評估，不能直接線上開藥。" }
      ]
  ...
  },
  {
    ...
    reply: answerPepVisitScheduleFollowUp(
      ...
      [
        ...
        { role: "assistant", content: "14 小時仍在 72 小時內，PEP 需要由醫師評估，不能直接線上開藥。" }
      ]
    ) ?? "",
    expected: [""],
  ...
  },
  {
    ...
    expected: ["精液有血", "血精", "不等於一定是癌症", "只靠訊息也無法排除", "感染", "發炎", "攝護腺", "不只一次", "泌尿科門診", "血尿", "尿痛", "發燒", "疼痛", "排尿困難", "02-2511-9488"],
  ...
  },
  {
    ...
    reply: await buildTestReply("我昨天射精看到精液有血，今天又有一點粉紅色，嚇到睡不著。這是不是癌症？我沒有發燒也不太痛，需要急診嗎？"),
    expected: ["精液有血", "血精", "不等於一定是癌症", "只靠訊息也無法排除", "沒有發燒", "明顯疼痛", "排尿困難", "通常不需要先急診", "泌尿科門診", "血尿", "尿痛", "發燒", "血量變多", "02-2511-9488"],
    forbidden: ["官網介紹：", "https://", "lin.ee", "就是癌症", "不是癌症", "立即急診", "不用看診", "可以放心", "會陰或下腹悶痛", "尿尿不太順", "射精後酸痛", "慢性攝護腺炎", "骨盆疼痛症候群"]
  },
  {
  ...
  },
  {
    ...
    expected: ["備孕一年未成功", "精液活動力偏低", "精索靜脈曲張", "泌尿科", "精液報告", "理學檢查", "陰囊超音波", "顯微精索靜脈曲張手術", "不能只靠訊息", "單一報告", "直接安排手術", "保證改善受孕", "費用", "評估後確認", "伴侶端", "婦產科", "生殖醫學", "02-2511-9488"],
  ...
  },
  {
    ...
    expected: ["PSA", "不等於一定是攝護腺癌", "不能只靠訊息判斷", "檢查報告", "切片", "醫師評估", "02-2511-9488"],
  ...
  },
  {
    ...
    expected: ["對", "先掛泌尿科門診", "PSA", "超音波", "檢查報告", "不要先把自己排成手術", "不等於一定是攝護腺癌", "不能只靠訊息判斷", "切片", "醫師評估", "水蒸氣消融", "Urolift", "不能用來取代", "02-2511-9488"],
  ...
  },
  {
    ...
    expected: ["尿痛", "發燒", "需要醫師評估", "抗生素", "今天晚上", "李齊泰醫師", "18:00-20:30", "02-2511-9488", "立即就醫"],
  ...
  {
    name: "chronic prostatitis-like pain avoids generic uti answer",
    reply: await buildTestReply("我這幾週會陰跟下腹一直悶悶痛，尿尿有時不太順，射精後也會酸痛。朋友說可能是慢性攝護腺炎，可以先吃之前剩的抗生素嗎？這會不會是癌症？需要急診嗎？"),
    expected: ["會陰", "下腹悶痛", "尿尿不太順", "射精後酸痛", "慢性攝護腺炎", "骨盆疼痛症候群", "不能只靠訊息診斷", "不建議自行吃之前剩的抗生素", "尿液檢查", "不等於一定是癌症", "持續幾週", "泌尿科門診", "沒有高燒", "尿不出來", "血尿變多", "劇烈疼痛", "通常不需要先急診", "02-2511-9488", "急診", "立即就醫"],
    forbidden: ["官網介紹：", "https://", "lin.ee", "尿痛、頻尿或急尿可能有不同原因", "需要評估是否為泌尿道感染", "可以先吃", "就是癌症", "不是癌症", "不用看診"]
  },
  {
  ...
  },
  {
    ...
    forbidden: ["肛門直腸外科，可評估痔瘡", "肛門疾病", "痔瘡微創手術", "攝護腺肥大", "雷射剜除", "水蒸氣消融", "綠光雷射", "Urolift", "不能直接線上判斷或報價", "今天（週二）", "李齊泰醫師", "https://"]
  },
  {
  ...
  },
  {
    ...
    expected: ["尿痛", "疑似血尿", "醫師評估", "需要醫師評估", "抗生素", "請不要自行服藥", "02-2511-9488", "血尿", "立即就醫"],
  ...
  },
  {
    ...
    expected: ["無痛肉眼血尿", "變正常", "不建議只觀察", "不等於一定是癌症", "抽菸", "膀胱", "泌尿道腫瘤", "結石", "感染", "需要排除", "光靠訊息無法診斷", "泌尿科", "尿液", "影像", "膀胱鏡", "血塊", "尿不出來", "急診", "立即就醫", "02-2511-9488"],
  ...
  },
  {
    ...
    expected: ["右腰痛到冒冷汗", "尿有點紅", "不能只靠訊息判斷", "腎結石", "輸尿管結石", "劇痛", "血尿", "優先急診", "02-2511-9488"],
  ...
  },
  {
    ...
    expected: ["尿色發紅", "腰痛", "側腹痛", "發燒", "腎臟", "輸尿管", "感染", "結石合併感染", "光靠訊息無法判斷", "不建議", "止痛藥", "家裡抗生素", "撐到明天", "急診", "立即就醫", "02-2511-9488"],
  ...
  },
  {
    ...
    expected: ["尿痛", "月經晚", "不確定是否懷孕", "泌尿道感染", "光靠訊息無法診斷", "先不要坐美磁波鍛肌椅", "漏尿或療程問題先延後", "醫師評估", "適合用藥", "02-2511-9488"],
  ...
  },
  {
    ...
    expected: ["尿痛", "尿紅/血尿", "月經晚", "不確定是否懷孕", "泌尿道感染", "孕期感染", "光靠訊息無法診斷", "不要自行吃家裡剩的抗生素", "醫師評估", "是否懷孕", "適合用藥", "02-2511-9488", "急診", "立即就醫"],
  ...
  },
  {
    ...
    reply: await buildTestReply("我週三晚上想去看頻尿跟夜尿，週三晚上的診是一般泌尿科嗎？如果不是，週三還有哪個時段比較適合？", [
      ...
      { role: "assistant", content: "術後第 5 天水腫、出血或釘子旁黃黃的狀況，光靠訊息無法判斷是否為感染或流膿。" },
      { role: "user", content: "我想做割包皮手術，有推薦的醫生嗎？" },
      { role: "assistant", content: "割包皮/包皮槍可先掛泌尿科或男性門診評估。" }
    ]),
    expected: ["週三", "晚診", "陳嘉哲醫師", "肛門直腸外科", "不是一般泌尿科門診", "週三可改一般門診時段", "午診", "吳致寬醫師", "02-2511-9488"],
    forbidden: ["包皮手術相關專長", "包皮槍", "陳偉傑醫師", "羅詩修醫師", "李齊泰醫師", "可以。今天", "光靠訊息無法判斷是否感染", "抗生素", "急診", "立即就醫", "官方 LINE", "LINE VOOM", "官網介紹：", "https://", "lin.ee"]
  },
  {
    ...
    expected: ["HPV", "九價", "價格", "02-2511-9488", "是否適合施打不能只靠訊息判斷", "過敏史", "個人狀況", "醫師或診所人員"],
  ...
  },
  {
    ...
    expected: ["HPV", "九價", "皮蛇疫苗", "價格", "庫存", "是否適合施打不能只靠訊息判斷", "是否懷孕", "過敏史", "兩種疫苗能否同一天打", "今天能不能直接打", "醫師或診所人員", "02-2511-9488"],
  ...
  },
  {
    ...
    expected: ["HPV", "九價", "降低", "菜花風險", "不能取代檢查", "醫師或診所人員", "性病篩檢", "施打", "是否適合施打不能只靠訊息判斷", "今天能不能直接打", "02-2511-9488"],
